...
#                     source_a=primary_citation, source_b=citation,
#                     value_a=str(max_primary_score), value_b=str(citation.reliability_score),
#                 ))
#         return contradictions
...
#     def detect(self, entry_a: RegulatoryEntry, entry_b: RegulatoryEntry,
#                source_a: CitationRecord, source_b: CitationRecord) -> list[ContradictionRecord]:
#         contradictions: list[ContradictionRecord] = []
...
#                 contradictions.append(ContradictionRecord(
#                     field_path=field_path, source_a=source_a, source_b=source_b,
